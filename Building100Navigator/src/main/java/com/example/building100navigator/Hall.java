...
//The Hall class represents the bridge between two Nodes, and contains variables that tells the user what two nodes that it connects, as well as the distance between them.
public class Hall {
